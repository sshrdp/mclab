...
\institute{Sable Research Group, McGill University}
\date{2010-03-16} 
...
%\setbeamerfont{mclab}{size=\Huge,

\section{Introduction} %Jesse
\input{intro}
\frame{\frametitle{Outline}\tableofcontents} 
\subsection*{Matlab} %Anton
\input{matlab}
\section{McLab} %Jesse
\input{mclab}
\subsection*{Extensible Design}  %Jesse
\input{extensible}
\section{Aspect Matlab} %Jesse
\input{aspectmatlab}
%\subsection{Domain} %Anton
\input{applications}
%\subsection{Examples} %Anton
\input{examples}
\subsection*{Domain-specific challenges} %Jesse
\input{challenges}
\section{Conclusion} %Anton
\input{outlook}
