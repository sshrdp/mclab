...
//		String file = "/home/2011/vkumar5/mclab/Project/languages/Natlab/src/natlab/backends/x10/testing/unitTests/ut8" ;
	  ...
	  GenericFile gFile = GenericFile.create(fileIn); 
		...
		irx10Program.setClassBlock(IRx10ASTGenerator.x10ClassMaker
			(analysis,size,"home/2011/vkumar5/", "testclass"));
		System.out.println(((AssignStmt)irx10Program.getClassBlock().
			getMethod(1).getMethodBlock().getStmt(5)).
		        	getVariableName());
		System.out.println(((AssignStmt)irx10Program.getClassBlock().
				getMethod(0).getMethodBlock().getStmt(0)).
			        	getVariableName());
		//.getMethodHeader().getNumArgs());//
		
		
//		for(int i=size-1;i>=0;i--){
//		System.out.println(x10CodeGenerator.x10CodePrinter(analysis,size,i,"home/2011/vkumar5/", "testclass"));
//		}
